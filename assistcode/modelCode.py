...
class WinBoard(models.Model):
    ...
    user = models.ForeignKey('WinUser', models.DO_NOTHING, db_comment='ȸ��-��ȸ�� �����ؼ� �˻� Ű���带 ����-��� �Ͻô� ��� id �÷��� �ܷ�Ű�� �Ǹ� ��ȸ���� ���� row ����� �Ұ����մϴ�')
...
class WinDetailView(models.Model):
    ...
    user = models.ForeignKey('WinUser', models.DO_NOTHING, blank=True, null=True, db_comment='ȸ��-��ȸ�� �����ؼ� �˻� Ű���带 ����-��� �Ͻô� ��� id �÷��� �ܷ�Ű�� �Ǹ� ��ȸ���� ���� row ����� �Ұ����մϴ�')
...
class WinSearch(models.Model):
    ...
    user_id = models.CharField(max_length=30, db_comment='ȸ��-��ȸ�� �����ؼ� �˻� Ű���带 ����-��� �Ͻô� ��� id �÷��� �ܷ�Ű�� �Ǹ� ��ȸ���� ���� row ����� �Ұ����մϴ�')
...
class WinUser(models.Model):
    user_id = models.CharField(primary_key=True, max_length=30, db_comment='ȸ��-��ȸ�� �����ؼ� �˻� Ű���带 ����-��� �Ͻô� ��� id �÷��� �ܷ�Ű�� �Ǹ� ��ȸ���� ���� row ����� �Ұ����մϴ�')
    user_grade = models.ForeignKey('WinUserGrade', models.DO_NOTHING, db_column='user_grade', db_comment='-1 / Ż�� ȸ��\r\n1 / �Ϲ� ȸ��\r\n2 / ���� ȸ��(�Ϲ� ȸ�� + ���� �߰� ����)')
...
class WinUserGrade(models.Model):
    user_grade = models.IntegerField(primary_key=True, db_comment='-1 / Ż�� ȸ��\r\n1 / �Ϲ� ȸ��\r\n2 / ���� ȸ��(�Ϲ� ȸ�� + ���� �߰� ����)')
