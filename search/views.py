...
class SearchByNameView(View):
    ...
    def post(self, request):
        ...
        results_count = start_results_count + include_results_count             # 회원 조회수와 비회원 조회수의 합
...
class SearchByCategoryView(View):
    ...
    def post(self, request):
        template = loader.get_template("search/searchByCategoryList.html")      # 카테고리 검색 결과 페이지
...
class SearchByRankView(View):
    ...
    def post(self, request):
        ...
        if rank_category == "purchaseqnty" :
            ...
            select_related("sell").
            values("sell__wine__wine_id", "sell__wine__wine_name", "sell__wine__wine_name_eng", "sell__wine__wine_image").
            ...
            list_by_rank = purchaseqnty_joined.values('sell__wine__wine_id').annotate(
            max_count=Count('sell__wine__wine_id'),
            w_i=F('sell__wine__wine_id')
            ).values('max_count', 'w_i', "sell__wine__wine_id", "sell__wine__wine_name",
             "sell__wine__wine_name_eng", "sell__wine__wine_image").order_by('-max_count')
        ...
        #
         # 판매 등록 수
            ...
            list_by_rank = sellregist_joined.values('wine__wine_id').annotate(
            max_count=Count('wine__wine_id'),
            w_i=F('wine__wine_id')
            ).values('max_count', 'w_i', "wine__wine_id", "wine__wine_name",
             "wine__wine_name_eng", "wine__wine_image").order_by('-max_count')
        ...
        # # 리뷰 개수
            ...
            reviewqnty_joined = (WinReview.objects.
            select_related("sell").
            values("sell__wine__wine_id", "sell__wine__wine_name", "sell__wine__wine_name_eng", "sell__wine__wine_image").
            order_by("review_id")
            )
            ...
            list_by_rank = reviewqnty_joined.values('sell__wine__wine_id').annotate(
            max_count=Count('sell__wine__wine_id'),
            w_i=F('sell__wine__wine_id')
            ).values('max_count', 'w_i', "sell__wine__wine_id", "sell__wine__wine_name",
            "sell__wine__wine_name_eng", "sell__wine__wine_image").order_by('-max_count')
        ...
        # # 리뷰 평점
            ...
            list_by_rank = reviewavg_joined.values('sell__wine__wine_id').annotate(
            avg=Avg('review_score'),
            w_i=F('sell__wine__wine_id')
            ).values('avg', 'w_i', "sell__wine__wine_id", "sell__wine__wine_name",
             "sell__wine__wine_name_eng", "sell__wine__wine_image").order_by('-avg')
        ...
        context = { "list_by_rank" : list_by_rank, "count" : count,
                   "rank_category" : rank_category, "rank_qnty" : rank_qnty }
        return HttpResponse(template.render(context, request))
